...
- `.\gradlew.bat :app:testDebugUnitTest :app:assembleDebug` passed on July 26, 2026 after the first visualizer/startup jank pass. Emulator launch still logged a startup Choreographer skipped-frame burst, so deeper profiling remains needed.
